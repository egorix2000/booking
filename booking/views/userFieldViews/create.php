...
$isOk = $service->addField($type, $access, $isRequired, $placeholder, $label);
...
<body>
  ...
  <div class="header">
    <div class="headerLabel">User Field</div>
  </div>
  ...
  <div class="inputDiv">
    <form action="create.php" method="post">
      ...
      <input class="headerButtonInput" type="submit" value="Create" name="create" />
    </form>
